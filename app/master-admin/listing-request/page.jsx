...
import { FaFilter, FaSearch, FaSync, FaPhone, FaUser, FaClock, FaMapMarkerAlt, FaBuilding, FaBed, FaHome, FaWarehouse, FaHotel, FaStore } from "react-icons/fa";
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex flex-col gap-3 md:flex-1">
                  ...
                  <div className="flex items-start gap-2 text-gray-700">
                    ...
                    <span className="text-sm font-medium">{req.address}</span>
                  </div>
                </div>
