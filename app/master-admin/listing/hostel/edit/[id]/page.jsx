...
export default function EditHostel() {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setFormData({
          ...
          quantity: hostel.quantity || 1,
          availability: hostel.availability !== undefined ? hostel.availability : true,
          isVerified: hostel.isVerified !== undefined ? hostel.isVerified : true,
          isShow: hostel.isShow !== undefined ? hostel.isShow : false,
          
          facilities: hostel.facilities || [],
          pricePlans: hostel.pricePlans || [],
          
          mainImage: hostel.mainImage || null,
          otherImages: hostel.otherImages || [],
          youtubeLink: hostel.youtubeLink || "",
          
          description: hostel.description || "",
          messDescription: hostel.messDescription || "",
          horooDescription: hostel.horooDescription || ""
        });

        setNearbyAreas(hostel.nearbyAreas?.length ? hostel.nearbyAreas : [""]);
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`${api}/hostel/edit/${hostelId}`, submitData);
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Update hostel property details</p>
            </div>
          </div>
        </div>
      </div>
