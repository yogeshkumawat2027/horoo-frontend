    ...
    try {
      ...
      if (res.data.success) {
        ...
        setFormData({
          ...
          quantity: commercial.quantity || 1,
          availability: commercial.availability ?? true,
          isVerified: commercial.isVerified ?? true,
          isShow: commercial.isShow ?? false,
          facilities: commercial.facilities || [],
          availableFor: commercial.availableFor || [],
          pricePlans: commercial.pricePlans || [],
          mainImage: commercial.mainImage || null,
          otherImages: commercial.otherImages || [],
          youtubeLink: commercial.youtubeLink || "",
          description: commercial.description || "",
          horooDescription: commercial.horooDescription || ""
        });
        setNearbyAreas(commercial.nearbyAreas?.length ? commercial.nearbyAreas : [""]);
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        toast.error(res.data.message || "Failed to update commercial property");
      }
    } catch (error) {
      console.error('Update error:', error);
      toast.error(error.response?.data?.message || "Failed to update commercial property");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen ml-72 bg-gray-50 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Edit Commercial Property</h1>
        </div>
      </div>
