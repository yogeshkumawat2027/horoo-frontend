      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Add New Hotel Room</h1>
              <p className="text-gray-600">Create a new hotel room property listing</p>
            </div>
          </div>
        </div>
      </div>
