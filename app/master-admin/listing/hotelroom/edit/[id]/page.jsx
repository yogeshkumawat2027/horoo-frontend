...
export default function EditHotelRoom() {
  ...
  const fetchHotelRoomData = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        setFormData({
          propertyName: hotelRoom.propertyName || "",
          ...
          availableFor: hotelRoom.availableFor || [],
          quantity: hotelRoom.quantity || 1,
          availability: hotelRoom.availability !== undefined ? hotelRoom.availability : true,
          isVerified: hotelRoom.isVerified !== undefined ? hotelRoom.isVerified : true,
          isShow: hotelRoom.isShow !== undefined ? hotelRoom.isShow : false,
          
          facilities: hotelRoom.facilities || [],
          pricePlans: hotelRoom.pricePlans || [],
          
          mainImage: hotelRoom.mainImage || null,
          otherImages: hotelRoom.otherImages || [],
          youtubeLink: hotelRoom.youtubeLink || "",
          
          description: hotelRoom.description || "",
          horooDescription: hotelRoom.horooDescription || ""
        });

        setNearbyAreas(hotelRoom.nearbyAreas?.length ? hotelRoom.nearbyAreas : [""]);
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await adminApiCall(`/hotel/edit/${hotelRoomId}`, {
        method: 'PUT',
      ...
      toast.error(error.message || "Failed to update hotel room");
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading hotel room data...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen ml-72 bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Edit Hotel Room</h1>
              <p className="text-gray-600">Update hotel room property details</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center gap-2 mb-6">
            <FaHome className="text-orange-500" />
            <h2 className="text-xl font-semibold text-gray-800">Hotel Room Details</h2>
          </div>
