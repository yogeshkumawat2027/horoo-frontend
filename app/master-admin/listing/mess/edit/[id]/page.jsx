  ...
  const fetchMessData = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        setFormData({
          propertyName: mess.propertyName || "",
          horooName: mess.horooName || "",
          ownerName: mess.ownerName || "",
          ownerMobile: mess.ownerMobile || "",
          anotherNo: mess.anotherNo || "",
          
          state: mess.state?._id || "",
          city: mess.city?._id || "",
          area: mess.area?._id || "",
          pincode: mess.pincode || "",
          mapLink: mess.mapLink || "",
          realAddress: mess.realAddress || "",
          horooAddress: mess.horooAddress || "",
          
          ownerPrice: mess.ownerPrice || "",
          horooPrice: mess.horooPrice || "",
          offerType: mess.offerType || "",
          
          availability: mess.availability !== undefined ? mess.availability : true,
          isVerified: mess.isVerified !== undefined ? mess.isVerified : true,
          isShow: mess.isShow !== undefined ? mess.isShow : false,
          
          facilities: mess.facilities || [],
          availableFor: mess.availableFor || [],
          pricePlans: mess.pricePlans || [],
          
          mainImage: mess.mainImage || null,
          otherImages: mess.otherImages || [],
          youtubeLink: mess.youtubeLink || "",
          
          description: mess.description || "",
          horooDescription: mess.horooDescription || ""
        });
        
        setNearbyAreas(mess.nearbyAreas && mess.nearbyAreas.length > 0 ? mess.nearbyAreas : [""]);
      } else {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading mess data...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Edit Mess</h1>
          </div>
        </div>
      </div>
